        ...
        <div className='flex flex-col space-y-6 md:flex-row md:space-x-6 md:space-y-0 bg-cyan-700 w-full max-w-4xl p-8 rounded-xl shadow-lg text-white sm:p-12 overflow-hidden'>
          <div className='flex flex-col space-y-8 justify-between'>
            <div>
              ...
              <p className='pt-2 text-cyan-100 text-sm '>Have questions or need assistance? Our team is here to provide support, guidance, and answers. Reach out anytime!</p>
            </div>
            ...
            <div className='relative z-10 bg-white rounded-xl shadow-lg p-8 text-gray-600 md:w-80'>
              <form action="" className='flex flex-col space-y-4'>
                ...
                <div>
                  ...
                  <textarea type="text" placeholder='Message' rows={4} className='ring-1 ring-gray-300 w-full rounded-md px-4 py-2 mt-2 outline-none focus:ring-2 focus:ring-teal-300' />
                </div>
