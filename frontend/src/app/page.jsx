...
const Home = () => {
  return (
    <>
  {/* Hero */}
  <div className="bg-gray-800 dark:bg-neutral-950">
    ...
    <div className="relative max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="flex flex-col bg-white rounded-xl dark:bg-neutral-900">
            <div className="flex-auto p-4 md:p-6">
              <p className="text-base italic md:text-lg text-gray-800 dark:text-neutral-200">
                " With GrayPoll, we're able to easily create online poll during seminars and webinars to understand the opinion of the audience. It's become an essential tool for us to grow and
        ...
        <div className="flex h-auto">
          <div className="flex flex-col bg-white rounded-xl dark:bg-neutral-900">
            <div className="flex-auto p-4 md:p-6">
              <p className="text-base italic md:text-lg text-gray-800 dark:text-neutral-200">
                " In September, I will be using GrayPoll for 2 years. I went
          ...
          <div className="flex flex-col bg-white rounded-xl dark:bg-neutral-900">
            <div className="flex-auto p-4 md:p-6">
              <p className="text-base italic md:text-lg text-gray-800 dark:text-neutral-200">
                ...
                about how I can figure out the opinion of the audience during a meeting or seminar. Great typography, modern design, nice tones of the color. "
              </p>
            </div>
            <div className="p-4 bg-gray-100 rounded-b-xl md:px-7 dark:bg-neutral-800">
              <div className="flex items-center gap-x-3">
      ...
      <div className="mt-20 grid gap-6 grid-cols-2 sm:gap-12 lg:grid-cols-3 lg:gap-8">
        ...
        <div>
          ...
          <p className="mt-1 text-gray-400">partner with GrayPoll</p>
        </div>
        {/* End Stats */}
        {/* Stats */}
        <div>
