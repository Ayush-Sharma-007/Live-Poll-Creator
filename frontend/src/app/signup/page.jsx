...
const Login = () => {
  return (
    <div className='flex flex-col h-screen items-center justify-center w-full flex-1 px-20 text-center bg-gray-100'>

      <div className='bg-white rounded-2xl shadow-2xl flex w-2/3 max-w-4xl'>

      <div className='w-2/5 bg-green-500 py-36 px-12 text-white rounded-tl-2xl rounded-bl-2xl'>
      ...
      <a href="/login"><button className='border-2 border-white rounded-full px-12 py-2 inline-block mt-10 font-semibold hover:bg-white hover:text-green-500'>Login</button></a>
      </div>
      ...
      <div className='py-10'>
        ...
        <a href="/"><button className='border-2 border-green-500 text-green-500 rounded-full px-12 py-2 inline-block mt-10 font-semibold hover:bg-green-500 hover:text-white'>Sign Up</button></a>
      </div>
      </div>
    </div>
    </div>
